...
#if 1 /* V3 cache versions of H5AC_class_t definitions */
...
#else /* V2 cache versions of H5AC_class_t definitions */
...
#endif /* V2 cache versions of H5AC_class_t definitions */
